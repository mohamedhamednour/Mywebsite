...
const colorbg_ = ()=>{
  ...
  <div class="container-fluid nav">
    <Link  class="navbar-brand" to="/">M.H</Link>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
         <Link  class="nav-link" to="Portflio">portfolio</Link>
        </li>
        <li class="nav-item">
        ...
        <button class="nav-link" id="whitee" className="btn btn-light " onClick={colorbg} >bg white</button>
    <button  class="nav-link" id="dark" className="btn btn-dark " onClick={colorbg_} >bg dark</button>
      </ul>
    </div>
  </div>
</nav>
